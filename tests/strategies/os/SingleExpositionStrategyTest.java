...
class SingleExpositionStrategyTest {
    ...
    void generateInstances() {
        SingleExpositionStrategy single = new SingleExpositionStrategy(GenerationsNumStrategy.FIXED).setGenerationsNum(100);
        ...
        single = (SingleExpositionStrategy) new SingleExpositionStrategy(GenerationsNumStrategy.RATIO_DRIVEN).setGenerationsNum(10).setWindowSize(10);
        for (Instance instance : test2DNumericInstances) single.updateLabeled(instance, null);
