...
class InstanceUtilsTest {
    ...
    void createInstances() {
        Instances instances = InstanceUtils.createInstances(test2DNumericInstances.get(0), false);
    ...
    void findInstance() {
        ...
        Pair<Integer, Double> indexDist = InstanceUtils.findInstance(instance, instances, true);
        ...
        indexDist = InstanceUtils.findInstance(instance, instances, true);
        assertEquals(13, indexDist.getKey().intValue());
        assertEquals(0.0, indexDist.getValue(), 0.1);

        instance = test2DNumericInstances.get(5);
        indexDist = InstanceUtils.findInstance(instance, instances, false);
        assertEquals(13, indexDist.getKey().intValue());
        assertEquals(5.656, indexDist.getValue(), 0.001);
    }
