...
class NearestNeighborWindowedTest {
    ...
    @Test
    void constructor() {
        this.nnWindowed = new NearestNeighborWindowed(new LinearNNSearch(), 5,  test2DNumericInstances.get(0), false);
        ...
        this.nnWindowed = new NearestNeighborWindowed(new LinearNNSearch(), 5, InstanceUtils.prepareUnlabeled(test2DNumericInstances.get(0)), false);
        assertEquals(0.0, this.nnWindowed.getLuRatio());
    ...
    void getNearestNeighbors() {
        this.nnWindowed = new NearestNeighborWindowed(new LinearNNSearch(), 8,  test2DNumericInstances.get(0), false);
    ...
    @Test
    void updateCentroid() {
        this.nnWindowed = new NearestNeighborWindowed(new LinearNNSearch(), 2,  test2DNumericInstances.get(0), true);
